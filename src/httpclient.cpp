                                          ...
                                          const HttpClientLib::HttpResponse_ptr& response)
{
	...
	lua_pushnumber(luaState, response->requestId);
	lua_setfield(luaState, -2, "requestId");
	lua_pushnumber(luaState, response->version);
	lua_setfield(luaState, -2, "version");
	lua_pushnumber(luaState, response->statusCode);
	lua_setfield(luaState, -2, "statusCode");
	tfs::lua::pushString(luaState, response->location);
	lua_setfield(luaState, -2, "location");
	tfs::lua::pushString(luaState, response->contentType);
	lua_setfield(luaState, -2, "contentType");
	lua_pushnumber(luaState, response->responseTimeMs);
	lua_setfield(luaState, -2, "responseTimeMs");
	tfs::lua::pushString(luaState, response->headerData);
	lua_setfield(luaState, -2, "headerData");
	lua_pushnumber(luaState, response->bodySize);
	lua_setfield(luaState, -2, "bodySize");
	tfs::lua::pushString(luaState, response->bodyData);
	lua_setfield(luaState, -2, "bodyData");
	tfs::lua::pushBoolean(luaState, response->success);
	lua_setfield(luaState, -2, "success");
	tfs::lua::pushString(luaState, response->errorMessage);
	lua_setfield(luaState, -2, "errorMessage");
