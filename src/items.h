...
enum SlotPositionBits : uint32_t {
	...
	SLOTP_DEPOT = 1 << 9,
	SLOTP_TWO_HAND = 1 << 10,
	SLOTP_BACKPACK1 = 1 << 11,
	SLOTP_BACKPACK2 = 1 << 12,
	SLOTP_BACKPACK3 = 1 << 13,
	SLOTP_BACKPACK4 = 1 << 14,
	SLOTP_BACKPACK5 = 1 << 15,
	SLOTP_HAND = (SLOTP_LEFT | SLOTP_RIGHT),
	SLOTP_BACKPACK = (SLOTP_BACKPACK1 | SLOTP_BACKPACK2 | SLOTP_BACKPACK3 | SLOTP_BACKPACK4 | SLOTP_BACKPACK5),
};
