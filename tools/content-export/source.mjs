...
const gameRoot = path.resolve(workspaceRoot, "..", "LucattaQuestNBQ");
const commonRoot = path.join(gameRoot, "packages", "common");
const serverRoot = path.join(gameRoot, "packages", "server");
const commonDistTypesRoot = path.join(commonRoot, "dist", "types");
const ts = require(path.join(gameRoot, "node_modules", "typescript"));
...
export function loadMonsterSpells() {
